...
const CreateAgence = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await agenceService.createAgence(payload);
            navigate('/agences');
        } catch (err) {
            ...
            setError(getErrorMessage(err, "Erreur lors de la creation de l'agence."));
        } finally {
            setSaving(false);
        }
    };
    ...
    return (
        <div className="max-w-3xl mx-auto">
            <div className="mb-6 flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-slate-900">Nouvelle agence</h2>
                    <p className="mt-1 text-sm text-slate-500">Creez une nouvelle agence du reseau.</p>
                </div>
                <Link
                    to="/agences"
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={getInputClass('responsable_nom')}
                                />
                            ...
                            <div>
                                ...
                                <input
                                    id="capacite_max_vehicules"
                                    name="capacite_max_vehicules"
                                    type="number"
                                    min="0"
                                    value={formData.capacite_max_vehicules}
                                    onChange={handleChange}
                                    className={getInputClass('capacite_max_vehicules')}
                                />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={getInputClass('heure_ouverture')}
                                />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={getInputClass('heure_fermeture')}
                                />
                        ...
                        <div className="pt-6 flex justify-end space-x-3 border-t border-slate-100">
                            <button
                                ...
                                className="bg-white py-2 px-4 border border-slate-300 rounded-lg shadow-sm text-sm font-medium text-slate-700 hover:bg-slate-50"
                            >
                                Annuler
                            </button>
                            <button
                                type="submit"
                                disabled={saving}
                                className="inline-flex justify-center py-2 px-6 border border-transparent shadow-md text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700"
                            >
                                {saving ? 'Creation en cours...' : 'Creer agence'}
                            </button>
                        </div>
                    </form>
                </div>
