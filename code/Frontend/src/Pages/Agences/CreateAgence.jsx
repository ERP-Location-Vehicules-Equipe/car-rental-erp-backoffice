...
const CreateAgence = () => {
    ...
    const getInputClass = (fieldName) => (
        `shadow-sm block w-full sm:text-sm rounded-lg py-2 px-3 border ${
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccessMessage('Agence creee avec succes.');
            setTimeout(() => navigate('/agences'), 1000);
        } catch (err) {
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="pt-6 flex justify-end space-x-3 border-t border-slate-100">
                            ...
                            <button
                                type="submit"
                                disabled={saving}
                                className="inline-flex justify-center py-2 px-6 border border-transparent shadow-md text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed"
                            >
